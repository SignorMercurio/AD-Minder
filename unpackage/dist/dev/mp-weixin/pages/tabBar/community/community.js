...

{
  ...
  methods: {
    ...
    getList: function getList(val) {var _this = this;
      this.$set(this.listData, val, []);

      this.$ajax(this.list_name[val], null, function (ret) {
        if (ret.data[0] !== '<') {
          if (val !== 0) {
            _this.$set(_this.blank, val - 1, ret.data == '');
          }
          var temp_list = _this.listData[val].slice(0);
          for (var item in ret.data) {
            temp_list.push(ret.data[item]);
          }
          _this.$set(_this.listData, val, temp_list);
        } else {
          _this.$set(_this.blank, 0, true);
          _this.$set(_this.blank, 1, true);
        }
      });
    },
                ...
                return _c(
                  ...
                  [
                    ...
                    _c("view", { staticClass: "uni-card-footer" }, [
                      _c("view", { staticClass: "uni-card-link" }, [
                        _vm._v("赞同 " + _vm._s(value.agrees))
                      ])
                    ])
                  ]
                )
              }),
              idx !== 0 && _vm.blank[idx - 1]
...
//# sourceMappingURL=../../../../.sourcemap/mp-weixin/pages/tabBar/community/community.js.map