		...
		<view class="registercontent has-mgt-25">
			<view class="has-mglr-10 ">
				<view class=" has-mgtb-10 ">
					<input v-model="reg.mail" type="text" placeholder="请输入邮箱地址" class="is-input1 " />
				</view>
				<view class=" has-mgtb-10 ">
				...
				<view class=" has-radius has-mgtb-10">
					<input v-model="reg.username" @blur="check_uname" placeholder="请输入用户名" class="is-input1" />
				</view>
				<view class=" has-radius has-mgtb-10">
					<input v-model="reg.password" placeholder="请输入登录密码" :password="true" class="is-input1" />
				</view>
